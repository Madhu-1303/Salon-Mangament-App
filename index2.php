...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
          <h1 class="hero-title">UNISEX SALON MANAGEMENT SYSTEM <i class="fa fa-scissors"></i></h1>
  ...
  <section class="services">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="service">
            <img src="images/boy1.jpg" alt="Haircut">
        ...
        <div class="col-md-4">
          <div class="service">
            <img src="images/girls5.jpg" alt="Color">
            <h3>Beauty <i class="fa fa-adjust"></i> </h3>
            <p>Makeup isn't just about covering up, it's about celebrating you! Enhance your natural beauty, play with bold colors, or achieve a flawless canvas. We offer the tools for self-expression and the confidence to radiate from within. Discover your unique look and let your inner light shine.</p>
            <a href="service-list2.php" class="btn">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-md-4">
          <div class="service">
            <img src="images/boy3.jpg" alt="Styling">
  ...
  <section class="gallery">
    ...
    <div class="gallery-container">
      ...
      <img src="images/girls1.jpg" alt="Photo 2">
      <img src="images/portfolio-3.jpg" alt="Photo 3">
      <img src="images/girls2.jpg" alt="Photo 4">
      <img src="images/portfolio-4.jpg" alt="Photo 5">
      <img src="images/girls4.jpg" alt="Photo 6">
    </div>
  </section>
